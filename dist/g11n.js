	...
	var G11N = (function () {
	    ...
	    _createClass(G11N, [{
	        ...
	        value: function t(str) {
	            ...
	            ns = _utils.isString(obj) ? obj : ns;

	            var data = this.maps[ns] || {};

	            var item = _utils.get(data, str, str);

	            var key = undefined;

	            // 占位符處理
	            if (_utils.isObject(obj) && _utils.isString(item)) {
	                for (key in obj) {
	        ...
	        value: function bind(obj) {
	            ...
	            if (obj) {
	                this.maps[ns] = _objectAssign2['default'](this.maps[ns] || {}, obj);
	            }
	            return this;
	        }
	    }, {
	        ...
	        value: function imports(obj) {
	            ...
	            var items = _utils.isArray(obj) ? obj : [obj];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setUnscope = __webpack_require__(6)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!(UNSCOPABLES in []))__webpack_require__(11)(Array.prototype, UNSCOPABLES, {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(name){
	  return store[name] || (store[name] =
	    Symbol && Symbol[name] || (Symbol || __webpack_require__(10))('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ES5Object = __webpack_require__(18)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE){
	  ...
	  if(DEFAULT){
	    ...
	    } else $def($def.P + $def.F * __webpack_require__(29), NAME, methods);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Constructor, NAME, next){
	  Constructor.prototype = $.create(IteratorPrototype, {next: __webpack_require__(13)(1,next)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                = __webpack_require__(12)
	  ...
	  , arrayMethod      = __webpack_require__(35)
	  , IE_PROTO         = __webpack_require__(10)('__proto__')
	  ...
	  , ES5Object        = __webpack_require__(18)
	  ...
	  , $every           = arrayMethod(4)
	  , factories        = {}
	  , $trim            = __webpack_require__(43)(/^\s*([\s\S]*\S)?\s*$/, '$1');
	...
	var date       = new Date(-5e13 - 1)
	  , brokenDate = !(date.toISOString && date.toISOString() == '0385-07-25T07:06:39.999Z'
	      && __webpack_require__(44)(function(){ new Date(NaN).toISOString(); }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!useNative){
	  ...
	  if(SUPPORT_DESC && !__webpack_require__(22)){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $             = __webpack_require__(12)
	  ...
	  , NAME          = 'name';
	// 19.2.4.2 name
	NAME in FunctionProto || __webpack_require__(14) && setDesc(FunctionProto, NAME, {
	  configurable: true,
	  get: function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.P + $def.F * !__webpack_require__(44)(function(){ 'q'.endsWith(/./); }), 'String', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// should throw error on regex
	$def($def.P + $def.F * !__webpack_require__(44)(function(){ 'q'.startsWith(/./); }), 'String', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S + $def.F * !__webpack_require__(105)(function(iter){ Array.from(iter); }), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(C){
	  if(__webpack_require__(14) && !(SPECIES in C))$.setDesc(C, SPECIES, {
	    configurable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(6)('copyWithin');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(KEY, length, exec){
	  ...
	  if(function(){
	    ...
	    __webpack_require__(25)(String.prototype, KEY, exec(SYMBOL, original));
	    __webpack_require__(11)(RegExp.prototype, SYMBOL, length == 2
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(12)
	  ...
	  , SPECIES    = __webpack_require__(7)('species')
	  , RECORD     = __webpack_require__(10)('record')
	  , PROMISE    = 'Promise'
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK){
	  ...
	  function fixMethod(KEY){
	    var fn = proto[KEY];
	    __webpack_require__(25)(proto, KEY,
	  ...
	  if(typeof C != 'function' || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)){
	    ...
	    if(!__webpack_require__(105)(function(iter){ new C(iter); })){ // eslint-disable-line no-new
	...
	if(new $WeakMap().set((Object.freeze || Object)(tmp), 7).get(tmp) != 7){
	  $.each.call(['delete', 'has', 'get', 'set'], function(key){
	    var proto  = $WeakMap.prototype
	      , method = proto[key];
	    __webpack_require__(25)(proto, key, function(a, b){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hide         = __webpack_require__(11)
	  ...
	  , WEAK         = __webpack_require__(10)('weak')
	  , isObject     = __webpack_require__(31)
	  , $has         = __webpack_require__(26)
	  , isExtensible = Object.isExtensible || isObject
	  , find         = method(5)
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S + $def.F * __webpack_require__(44)(function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(27)(Enumerate, 'Object', function(){
	  var that = this
	    , keys = that._k
	    , key;
	  if(keys == undefined){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def          = __webpack_require__(23)
	  , anObject      = __webpack_require__(40)
	  , _isExtensible = Object.isExtensible || __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setStatics(keys, length){
	  $.each.call(keys.split(','), function(key){
	    ...
	    else if(key in [])statics[key] = __webpack_require__(36)(Function.call, [][key], length);
	  });
	}
